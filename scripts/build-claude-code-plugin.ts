...
console.log("  claude plugin install openspec-agents --scope project")
console.log("或会话内：/plugin marketplace add ./ → /plugin install openspec-agents；卸载 /plugin uninstall openspec-agents")
